...
| `features/<dominio>/` | Todo lo de un dominio: componentes, hooks y lógica de UI con sus tests (`auth`, `habits`, `today`, `close-day`, `sync`…) | Una funcionalidad nueva = una carpeta nueva aquí |
