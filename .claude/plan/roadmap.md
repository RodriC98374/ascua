...
|---|---|---|---|---|
| 12 | **Racha en riesgo e hitos** | Aviso en Hoy después de la hora del recordatorio con cuenta regresiva a la medianoche de Bolivia; celebraciones especiales a los 7, 30, 100 y 365 días con insignias propias (SVG) y una vista de insignias ganadas | Poco: los hitos se derivan de la racha; las insignias ganadas, en una subcolección nueva si hace falta guardarlas | No |
