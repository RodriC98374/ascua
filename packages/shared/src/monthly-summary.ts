...
/** Los contadores del mes después de cerrar un día de ese mes. */
export function addClosedDay(before: MonthlyCounters, evaluation: DayEvaluation): MonthlyCounters {
